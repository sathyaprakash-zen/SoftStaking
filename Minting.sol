...
//
// A collection of 2,222 unique Non-Fungible tokens living in
// the metaverse. Becoming a NFT owner introduces you to
// a FAMILY of heart-centered, purpose-driven, service-oriented human
// beings.
//
// https://www.sathyaprakash.com
//
    ...
    ERC721BContractURIStorage
{
        ...
        returns (address receiver, uint256 royaltyAmount)
    {
        ...
        return (payable(owner()), _salePrice.mul(1000).div(10000));
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked(baseTokenURI(), index.toString(), ".json"));
    }
     ...
     */
    function authorize(bytes memory proof) external payable {
    ...
    function redeem(
        ...
        if (ambassador) {
            ...
            //they are apart of the founding team
